...
describe SchedulesController do
    ...
    describe "##{action}" do
      context "when the agenda is not found" do
        it "raises an exception" do
          expect { get action, agenda_token: "1" }.to raise_exception(ActiveRecord::RecordNotFound)
        end
      end
    end
  end
  ...
  describe '#index' do
    context "when the agenda is still processing" do
      ...
      before do
        ...
        get :index, agenda_token: "a_token"
      end
    ...
    context "when the agenda is empty" do
      ...
      before do
        ...
        get :index, agenda_token: agenda.token
      end
    ...
    context "when the agenda is found" do
      ...
      before { get :index, agenda_token: agenda.token }
    ...
    context "when a page is past in" do
      ...
      before do
        ...
        get :index, agenda_token: "a_token", page: 10
      end
  ...
  describe '#processing' do
    ...
    context "when the agenda is still processing" do
      ...
      before { get :processing, agenda_token: "a_token" }
